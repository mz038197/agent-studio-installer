...
app = typer.Typer(
    name="add-studio-shell",
    help="Install the workshop Studio Streamlit shell into the current project.",
...
def install(
    ...
    force: bool = typer.Option(
        ...
        "--force",
        "-f",
        help="Replace an existing studio_shell/ after backing it up.",
    ),
    update: bool = typer.Option(
        ...
        "-u",
        help=(
            "Update shell core in place while preserving workspace, pages, "
            "sessions, scripts, and uploads."
        ),
    ),
    ...
    """Copy studio_shell/ into a workshop project."""
    ...
    typer.secho(f"Studio shell {action}.", fg=typer.colors.GREEN)
    ...
    typer.echo("")
    typer.echo("Next:")
    typer.echo("  uv run streamlit run studio_shell/app.py")
